            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->isTeacher())
                        ...
                        <x-nav-link :href="route('teacher.announcements.index')" :active="request()->routeIs('teacher.announcements.*')">
                            {{ __('Announcements') }}
                        </x-nav-link>
                    @else
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->isTeacher())
                ...
                <x-responsive-nav-link :href="route('teacher.announcements.index')" :active="request()->routeIs('teacher.announcements.*')">
                    {{ __('Announcements') }}
                </x-responsive-nav-link>
            @else
                ...
                <x-responsive-nav-link :href="route('student.announcements.index')" :active="request()->routeIs('student.announcements.*')">
                    {{ __('Announcements') }}
                </x-responsive-nav-link>
            @endif
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <div class="flex items-center px-4 py-2">
                    <span class="text-sm text-gray-500 dark:text-gray-400 mr-4">Theme:</span>
                    <x-theme-switch />
                </div>
