                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('teacher.assignments.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ __('Create Assignment') }}</x-primary-button>
                            <a href="{{ route('teacher.assignments.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </form>
